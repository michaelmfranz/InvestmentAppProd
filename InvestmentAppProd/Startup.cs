...
namespace InvestmentAppProd
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<OurDBContext>(options => options.UseInMemoryDatabase("Investments"));
            services.AddTransient<GenericRepository<Investment>, GenericRepository<Investment>>();
